    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
                ...
                <input name="phone" placeholder="Telefone" value={formData.phone} onChange={handleChange} className="input-field" />
                <input name="email" type="email" placeholder="E-mail" value={formData.email} onChange={handleChange} className="input-field" />
                <input name="instagram" placeholder="@instagram" value={formData.instagram} onChange={handleChange} className="input-field" />
                <input name="ownerName" placeholder="Nome do Proprietário" value={formData.ownerName} onChange={handleChange} className="input-field" />
                <input name="ownerPhone" placeholder="WhatsApp do Proprietário" value={formData.ownerPhone} onChange={handleChange} className="input-field col-span-1 md:col-span-2" />
            </div>
