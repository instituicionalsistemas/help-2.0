...
const TeamMemberForm: React.FC<TeamMemberFormProps> = ({ initialData, onClose }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h2 className="text-2xl font-bold text-center mb-6">{initialData ? 'Editar Membro da Equipe' : 'Adicionar Membro'}</h2>
      
      <div>
        <label htmlFor="role" className="block text-sm font-medium text-dark-secondary mb-1">Cargo</label>
        <select
          name="role"
          id="role"
          value={formData.role}
